...
import { getAllPosts, likePost } from "../../utils/actions/postActions";
...
const PostScreen = () => {
  ...
  const FirstRoute = () => (
    <ScrollView>
      {/* <View style={{ marginStart: 20 }}>
        <HeaderTitle text="Learn English" fontSize={20} />
      </View> */}
  ...
  // following
  const SecondRoute = () => <View style={styles.routeContainer} />;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <BackButton />
        {/* <View style={{ backgroundColor: colors.pink, borderRadius: 20, paddingHorizontal: 15, paddingVertical: 5}}>
          <BoldText text="" font={18} color="white" />
        </View> */}

        <MaterialIcons name="" size={24} color={colors.pink} />
      </View>

      <ScrollView style={{ marginBottom: 40, marginTop: 20 }} showsVerticalScrollIndicator={false}>
        {posts.map((item) => {
          let reaction = item.like.length;
          let dateTimeString = item.createdAt;
          let dateTime = new Date(dateTimeString);
